...
import zaid from "/videos/zaid-video.mp4";
import dev from "/videos/dev.mp4";
import saharanpurclub from "/videos/saharanpurclub.mp4";
import devansh from "/videos/devansh.mp4";
import rohit from "/videos/rohit.mp4";
import zaids from "/videos/zaids.mp4";
    ...
    <div className="projects-container" id="projects">
      ...
      <div className="projects-grid">
        <div className="project">
          <video src={zaid} className="zoom" width="100%" controls playsInline muted preload="metadata"></video>
            <h2>Zaid Siddique</h2>
          <p>
        ...
        <div className="project">
          <video src={dev} className="zoom" width="100%" controls playsInline muted preload="metadata"></video>
            <h2>Dev</h2>
          <p>
        ...
        <div className="project">
          <video src={devansh} className="zoom" width="100%" controls playsInline muted preload="metadata"></video>
            <h2>Dev</h2>
          <p>
        ...
        <div className="project">
          <video src={rohit} className="zoom" width="100%" controls playsInline muted preload="metadata"></video>
            <h2>Rohit</h2>
          <p>
        ...
        <div className="project">
          <video src={zaids} className="zoom" width="100%" controls playsInline muted preload="metadata"></video>
            <h2>Zaid Siddique</h2>
          <p>
