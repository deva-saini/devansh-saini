    ...
    <div className="projects-container" id="projects">
      ...
      <div className="projects-grid">
        <div className="project">
          <video src="/videos/zaid-video.mp4" className="zoom" width="100%" controls playsInline muted preload="metadata"></video>
            <h2>Zaid Siddique</h2>
          <p>
        ...
        <div className="project">
          <video src="/videos/dev.mp4" className="zoom" width="100%" controls playsInline muted preload="metadata"></video>
            <h2>Dev</h2>
          <p>
        ...
        <div className="project">
          <video src="/videos/devansh.mp4" className="zoom" width="100%" controls playsInline muted preload="metadata"></video>
            <h2>Dev</h2>
          <p>
        ...
        <div className="project">
          <video src="/videos/rohit.mp4" className="zoom" width="100%" controls playsInline muted preload="metadata"></video>
            <h2>Rohit</h2>
          <p>
        ...
        <div className="project">
          <video src="/videos/zaids.mp4" className="zoom" width="100%" controls playsInline muted preload="metadata"></video>
            <h2>Zaid Siddique</h2>
          <p>
